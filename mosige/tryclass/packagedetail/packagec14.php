...
借助瑜伽球完成瑜伽体式的练习，主动调动习练者的力量和柔韧性，让瑜伽的习练变得简单有趣。
</br>
</br>
上课周期：4节课/期 50分钟/节 </br>

课程内容：力量/柔韧两部分组成，根据会员实际情况老师会适度调整课程内容</br>

适合人群：身体僵硬，难以安静的会员，缺乏力量的会员 </br>
腰椎有严重问题的会员需谨慎选择
...
<div id="datouwang" class="jcImgScroll" align="center" width="120%" height="120%">
	<ul>
		<li><a  path="../img/package/yujiaqiu_yoga/1.JPG"></a></li>
		<li><a  path="../img/package/yujiaqiu_yoga/2.JPG"></a></li>
		<li><a  path="../img/package/yujiaqiu_yoga/3.JPG"></a></li>
		<li><a  path="../img/package/yujiaqiu_yoga/4.JPG"></a></li>
		<li><a  path="../img/package/yujiaqiu_yoga/5.JPG"></a></li>
		<li><a  path="../img/package/yujiaqiu_yoga/6.JPG"></a></li>
