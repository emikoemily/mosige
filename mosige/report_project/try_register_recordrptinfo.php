...
$try_register_record = NULL;

//
// Table class for try_register_record
//
class crtry_register_record extends crTableBase {
	var $register_id;
	var $arrange_id;
	var $member_id;
	var $register_time;
	...
	function __construct() {
		...
		$this->TableVar = 'try_register_record';
		$this->TableName = 'try_register_record';
		...
		// register_id
		$this->register_id = new crField('try_register_record', 'try_register_record', 'x_register_id', 'register_id', '`register_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// arrange_id
		$this->arrange_id = new crField('try_register_record', 'try_register_record', 'x_arrange_id', 'arrange_id', '`arrange_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// member_id
		$this->member_id = new crField('try_register_record', 'try_register_record', 'x_member_id', 'member_id', '`member_id`', 200, EWR_DATATYPE_STRING, -1);
		...
		// register_time
		$this->register_time = new crField('try_register_record', 'try_register_record', 'x_register_time', 'register_time', '`register_time`', 135, EWR_DATATYPE_DATE, 5);
		...
		// is_attended
		$this->is_attended = new crField('try_register_record', 'try_register_record', 'x_is_attended', 'is_attended', '`is_attended`', 16, EWR_DATATYPE_NUMBER, -1);
		...
		// attent_time
		$this->attent_time = new crField('try_register_record', 'try_register_record', 'x_attent_time', 'attent_time', '`attent_time`', 200, EWR_DATATYPE_STRING, -1);
		...
		// reviewed
		$this->reviewed = new crField('try_register_record', 'try_register_record', 'x_reviewed', 'reviewed', '`reviewed`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// is_canceled
		$this->is_canceled = new crField('try_register_record', 'try_register_record', 'x_is_canceled', 'is_canceled', '`is_canceled`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`try_register_record`";
	}
