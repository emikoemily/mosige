...
<?php include_once "try_member_userrptinfo.php" ?>
<?php
...
$try_member_user_rpt = NULL; // Initialize page object first

class crtry_member_user_rpt extends crtry_member_user {
	...
	// Page object name
	var $PageObjName = 'try_member_user_rpt';
	...
	function __construct() {
		...
		// Table object (try_member_user)
		if (!isset($GLOBALS["try_member_user"])) {
			$GLOBALS["try_member_user"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["try_member_user"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'try_member_user', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ftry_member_userrpt";
	}
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_try_member_user\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_try_member_user',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ftry_member_userrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ftry_member_userrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ftry_member_userrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
				...
				$this->FirstRowData['id_try'] = ewr_Conv($rs->fields('id_try'),3);
		...
		if (!$rs->EOF) {
			$this->id_try->setDbValue($rs->fields('id_try'));
			...
			$this->Val[1] = $this->id_try->CurrentValue;
			$this->Val[2] = $this->member_id->CurrentValue;
			$this->Val[3] = $this->member_name->CurrentValue;
			$this->Val[4] = $this->member_sex->CurrentValue;
			$this->Val[5] = $this->member_cell->CurrentValue;
			$this->Val[6] = $this->member_email->CurrentValue;
			$this->Val[7] = $this->member_level->CurrentValue;
			...
			$this->Val[13] = $this->member_regtime->CurrentValue;
			$this->Val[14] = $this->member_startdate->CurrentValue;
			$this->Val[15] = $this->member_days->CurrentValue;
			$this->Val[16] = $this->member_classcount->CurrentValue;
			$this->Val[17] = $this->member_attendmax->CurrentValue;
			$this->Val[18] = $this->member_intro->CurrentValue;
		} else {
			$this->id_try->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_try
			$this->id_try->ViewValue = $this->id_try->CurrentValue;
			$this->id_try->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_try
			$CurrentValue = $this->id_try->CurrentValue;
			$ViewValue = &$this->id_try->ViewValue;
			$ViewAttrs = &$this->id_try->ViewAttrs;
			$CellAttrs = &$this->id_try->CellAttrs;
			$HrefValue = &$this->id_try->HrefValue;
			$LinkAttrs = &$this->id_try->LinkAttrs;
			$this->Cell_Rendered($this->id_try, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		$this->DtlFldCount = 0;
		if ($this->id_try->Visible) $this->DtlFldCount += 1;
...
// Create page object
if (!isset($try_member_user_rpt)) $try_member_user_rpt = new crtry_member_user_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$try_member_user_rpt;
...
// Create page object
var try_member_user_rpt = new ewr_Page("try_member_user_rpt");

// Page properties
try_member_user_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = try_member_user_rpt.PageID;

// Extend page with Chart_Rendering function
try_member_user_rpt.Chart_Rendering = 
...
try_member_user_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php if ($Page->id_try->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_try"><div class="try_member_user_id_try"><span class="ewTableHeaderCaption"><?php echo $Page->id_try->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_try">
<?php if ($Page->SortUrl($Page->id_try) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_id_try">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_try->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_id_try" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_try) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_try->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_try->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_try->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_id"><div class="try_member_user_member_id"><span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_id">
<?php if ($Page->SortUrl($Page->member_id) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_name"><div class="try_member_user_member_name"><span class="ewTableHeaderCaption"><?php echo $Page->member_name->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_name">
<?php if ($Page->SortUrl($Page->member_name) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_name">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_name->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_name" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_name) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_name->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_sex"><div class="try_member_user_member_sex"><span class="ewTableHeaderCaption"><?php echo $Page->member_sex->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_sex">
<?php if ($Page->SortUrl($Page->member_sex) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_sex">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_sex->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_sex" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_sex) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_sex->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_cell"><div class="try_member_user_member_cell"><span class="ewTableHeaderCaption"><?php echo $Page->member_cell->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_cell">
<?php if ($Page->SortUrl($Page->member_cell) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_cell">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_cell->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_cell" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_cell) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_cell->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_email"><div class="try_member_user_member_email"><span class="ewTableHeaderCaption"><?php echo $Page->member_email->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_email">
<?php if ($Page->SortUrl($Page->member_email) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_email">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_email->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_email->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_level"><div class="try_member_user_member_level"><span class="ewTableHeaderCaption"><?php echo $Page->member_level->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_level">
<?php if ($Page->SortUrl($Page->member_level) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_level">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_level->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_level" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_level) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_level->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_points"><div class="try_member_user_member_points"><span class="ewTableHeaderCaption"><?php echo $Page->member_points->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_points">
<?php if ($Page->SortUrl($Page->member_points) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_points">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_points->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_points" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_points) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_points->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_weixinid"><div class="try_member_user_member_weixinid"><span class="ewTableHeaderCaption"><?php echo $Page->member_weixinid->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_weixinid">
<?php if ($Page->SortUrl($Page->member_weixinid) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_weixinid">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_weixinid->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_weixinid" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_weixinid) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_weixinid->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_cardid"><div class="try_member_user_member_cardid"><span class="ewTableHeaderCaption"><?php echo $Page->member_cardid->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_cardid">
<?php if ($Page->SortUrl($Page->member_cardid) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_cardid">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_cardid->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_cardid" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_cardid) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_cardid->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_password"><div class="try_member_user_member_password"><span class="ewTableHeaderCaption"><?php echo $Page->member_password->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_password">
<?php if ($Page->SortUrl($Page->member_password) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_password">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_password->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_password" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_password) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_password->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_enddate"><div class="try_member_user_member_enddate"><span class="ewTableHeaderCaption"><?php echo $Page->member_enddate->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_enddate">
<?php if ($Page->SortUrl($Page->member_enddate) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_enddate">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_enddate->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_enddate" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_enddate) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_enddate->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_regtime"><div class="try_member_user_member_regtime"><span class="ewTableHeaderCaption"><?php echo $Page->member_regtime->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_regtime">
<?php if ($Page->SortUrl($Page->member_regtime) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_regtime">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_regtime->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_regtime" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_regtime) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_regtime->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_startdate"><div class="try_member_user_member_startdate"><span class="ewTableHeaderCaption"><?php echo $Page->member_startdate->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_startdate">
<?php if ($Page->SortUrl($Page->member_startdate) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_startdate">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_startdate->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_startdate" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_startdate) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_startdate->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_days"><div class="try_member_user_member_days"><span class="ewTableHeaderCaption"><?php echo $Page->member_days->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_days">
<?php if ($Page->SortUrl($Page->member_days) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_days">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_days->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_days" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_days) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_days->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_classcount"><div class="try_member_user_member_classcount"><span class="ewTableHeaderCaption"><?php echo $Page->member_classcount->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_classcount">
<?php if ($Page->SortUrl($Page->member_classcount) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_classcount">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_classcount->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_classcount" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_classcount) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_classcount->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_attendmax"><div class="try_member_user_member_attendmax"><span class="ewTableHeaderCaption"><?php echo $Page->member_attendmax->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_attendmax">
<?php if ($Page->SortUrl($Page->member_attendmax) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_attendmax">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_attendmax->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_attendmax" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_attendmax) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_attendmax->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_intro"><div class="try_member_user_member_intro"><span class="ewTableHeaderCaption"><?php echo $Page->member_intro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_intro">
<?php if ($Page->SortUrl($Page->member_intro) == "") { ?>
		<div class="ewTableHeaderBtn try_member_user_member_intro">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_intro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer try_member_user_member_intro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_intro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_intro->FldCaption() ?></span>
...
<?php if ($Page->id_try->Visible) { ?>
		<td data-field="id_try"<?php echo $Page->id_try->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_id_try"<?php echo $Page->id_try->ViewAttributes() ?>><?php echo $Page->id_try->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_id->Visible) { ?>
		<td data-field="member_id"<?php echo $Page->member_id->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_id"<?php echo $Page->member_id->ViewAttributes() ?>><?php echo $Page->member_id->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_name->Visible) { ?>
		<td data-field="member_name"<?php echo $Page->member_name->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_name"<?php echo $Page->member_name->ViewAttributes() ?>><?php echo $Page->member_name->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_sex->Visible) { ?>
		<td data-field="member_sex"<?php echo $Page->member_sex->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_sex"<?php echo $Page->member_sex->ViewAttributes() ?>><?php echo $Page->member_sex->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_cell->Visible) { ?>
		<td data-field="member_cell"<?php echo $Page->member_cell->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_cell"<?php echo $Page->member_cell->ViewAttributes() ?>><?php echo $Page->member_cell->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_email->Visible) { ?>
		<td data-field="member_email"<?php echo $Page->member_email->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_email"<?php echo $Page->member_email->ViewAttributes() ?>><?php echo $Page->member_email->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_level->Visible) { ?>
		<td data-field="member_level"<?php echo $Page->member_level->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_level"<?php echo $Page->member_level->ViewAttributes() ?>><?php echo $Page->member_level->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_points->Visible) { ?>
		<td data-field="member_points"<?php echo $Page->member_points->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_points"<?php echo $Page->member_points->ViewAttributes() ?>><?php echo $Page->member_points->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_weixinid->Visible) { ?>
		<td data-field="member_weixinid"<?php echo $Page->member_weixinid->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_weixinid"<?php echo $Page->member_weixinid->ViewAttributes() ?>><?php echo $Page->member_weixinid->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_cardid->Visible) { ?>
		<td data-field="member_cardid"<?php echo $Page->member_cardid->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_cardid"<?php echo $Page->member_cardid->ViewAttributes() ?>><?php echo $Page->member_cardid->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_password->Visible) { ?>
		<td data-field="member_password"<?php echo $Page->member_password->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_password"<?php echo $Page->member_password->ViewAttributes() ?>><?php echo $Page->member_password->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_enddate->Visible) { ?>
		<td data-field="member_enddate"<?php echo $Page->member_enddate->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_enddate"<?php echo $Page->member_enddate->ViewAttributes() ?>><?php echo $Page->member_enddate->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_regtime->Visible) { ?>
		<td data-field="member_regtime"<?php echo $Page->member_regtime->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_regtime"<?php echo $Page->member_regtime->ViewAttributes() ?>><?php echo $Page->member_regtime->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_startdate->Visible) { ?>
		<td data-field="member_startdate"<?php echo $Page->member_startdate->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_startdate"<?php echo $Page->member_startdate->ViewAttributes() ?>><?php echo $Page->member_startdate->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_days->Visible) { ?>
		<td data-field="member_days"<?php echo $Page->member_days->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_days"<?php echo $Page->member_days->ViewAttributes() ?>><?php echo $Page->member_days->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_classcount->Visible) { ?>
		<td data-field="member_classcount"<?php echo $Page->member_classcount->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_classcount"<?php echo $Page->member_classcount->ViewAttributes() ?>><?php echo $Page->member_classcount->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_attendmax->Visible) { ?>
		<td data-field="member_attendmax"<?php echo $Page->member_attendmax->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_attendmax"<?php echo $Page->member_attendmax->ViewAttributes() ?>><?php echo $Page->member_attendmax->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_intro->Visible) { ?>
		<td data-field="member_intro"<?php echo $Page->member_intro->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_try_member_user_member_intro"<?php echo $Page->member_intro->ViewAttributes() ?>><?php echo $Page->member_intro->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "try_member_userrptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
</div>
