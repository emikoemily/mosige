...
if (!defined("EW_USE_mysqliI")) define("EW_USE_mysqliI", extension_loaded("mysqlii"), TRUE); // Use mysqlii
?>
...
class cryoga_lu_db extends crDbHelper {

	// Database connection info
	var $Host = '127.0.0.1';
	var $Port = 3306;
	var $Username = 'yoga_lu';
	var $Password = 'Yooq_yoga_lu';
	var $DbName = 'yoga_lu';
	...
	function &Connect($info = NULL) {
		...
		if ($this->mysqliCharset <> "")
			$conn->Execute("SET NAMES '" . $this->mysqliCharset . "'");
		$conn->raiseErrorFn = '';
		return $conn;
	}
}
