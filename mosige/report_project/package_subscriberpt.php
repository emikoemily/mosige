...
<?php include_once "package_subscriberptinfo.php" ?>
<?php
...
$package_subscribe_rpt = NULL; // Initialize page object first

class crpackage_subscribe_rpt extends crpackage_subscribe {
	...
	// Page object name
	var $PageObjName = 'package_subscribe_rpt';
	...
	function __construct() {
		...
		// Table object (package_subscribe)
		if (!isset($GLOBALS["package_subscribe"])) {
			$GLOBALS["package_subscribe"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["package_subscribe"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'package_subscribe', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fpackage_subscriberpt";
	}
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_package_subscribe\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_package_subscribe',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fpackage_subscriberpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fpackage_subscriberpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fpackage_subscriberpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
				...
				$this->FirstRowData['package_status'] = ewr_Conv($rs->fields('package_status'),3);
		...
		if (!$rs->EOF) {
			...
			$this->package_status->setDbValue($rs->fields('package_status'));
			...
			$this->Val[4] = $this->package_attended->CurrentValue;
			$this->Val[5] = $this->package_status->CurrentValue;
			$this->Val[6] = $this->payment_id->CurrentValue;
		} else {
			$this->idpackage_subscribe->setDbValue("");
			$this->member_id->setDbValue("");
			$this->package_id->setDbValue("");
			$this->package_attended->setDbValue("");
			$this->package_status->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// package_status
			$this->package_status->ViewValue = $this->package_status->CurrentValue;
			$this->package_status->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// package_status
			$CurrentValue = $this->package_status->CurrentValue;
			$ViewValue = &$this->package_status->ViewValue;
			$ViewAttrs = &$this->package_status->ViewAttrs;
			$CellAttrs = &$this->package_status->CellAttrs;
			$HrefValue = &$this->package_status->HrefValue;
			$LinkAttrs = &$this->package_status->LinkAttrs;
			$this->Cell_Rendered($this->package_status, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->package_status->Visible) $this->DtlFldCount += 1;
...
// Create page object
if (!isset($package_subscribe_rpt)) $package_subscribe_rpt = new crpackage_subscribe_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$package_subscribe_rpt;
...
// Create page object
var package_subscribe_rpt = new ewr_Page("package_subscribe_rpt");

// Page properties
package_subscribe_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = package_subscribe_rpt.PageID;

// Extend page with Chart_Rendering function
package_subscribe_rpt.Chart_Rendering = 
...
package_subscribe_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="idpackage_subscribe"><div class="package_subscribe_idpackage_subscribe"><span class="ewTableHeaderCaption"><?php echo $Page->idpackage_subscribe->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="idpackage_subscribe">
<?php if ($Page->SortUrl($Page->idpackage_subscribe) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_idpackage_subscribe">
			<span class="ewTableHeaderCaption"><?php echo $Page->idpackage_subscribe->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_idpackage_subscribe" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->idpackage_subscribe) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->idpackage_subscribe->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="member_id"><div class="package_subscribe_member_id"><span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="member_id">
<?php if ($Page->SortUrl($Page->member_id) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_member_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_member_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->member_id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->member_id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="package_id"><div class="package_subscribe_package_id"><span class="ewTableHeaderCaption"><?php echo $Page->package_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="package_id">
<?php if ($Page->SortUrl($Page->package_id) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_package_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_package_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->package_id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="package_attended"><div class="package_subscribe_package_attended"><span class="ewTableHeaderCaption"><?php echo $Page->package_attended->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="package_attended">
<?php if ($Page->SortUrl($Page->package_attended) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_package_attended">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_attended->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_package_attended" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->package_attended) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_attended->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->package_status->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="package_status"><div class="package_subscribe_package_status"><span class="ewTableHeaderCaption"><?php echo $Page->package_status->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="package_status">
<?php if ($Page->SortUrl($Page->package_status) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_package_status">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_status->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_package_status" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->package_status) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->package_status->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->package_status->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->package_status->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="payment_id"><div class="package_subscribe_payment_id"><span class="ewTableHeaderCaption"><?php echo $Page->payment_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="payment_id">
<?php if ($Page->SortUrl($Page->payment_id) == "") { ?>
		<div class="ewTableHeaderBtn package_subscribe_payment_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->payment_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer package_subscribe_payment_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->payment_id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->payment_id->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_idpackage_subscribe"<?php echo $Page->idpackage_subscribe->ViewAttributes() ?>><?php echo $Page->idpackage_subscribe->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->member_id->Visible) { ?>
		<td data-field="member_id"<?php echo $Page->member_id->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_member_id"<?php echo $Page->member_id->ViewAttributes() ?>><?php echo $Page->member_id->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->package_id->Visible) { ?>
		<td data-field="package_id"<?php echo $Page->package_id->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_package_id"<?php echo $Page->package_id->ViewAttributes() ?>><?php echo $Page->package_id->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->package_attended->Visible) { ?>
		<td data-field="package_attended"<?php echo $Page->package_attended->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_package_attended"<?php echo $Page->package_attended->ViewAttributes() ?>><?php echo $Page->package_attended->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->package_status->Visible) { ?>
		<td data-field="package_status"<?php echo $Page->package_status->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_package_status"<?php echo $Page->package_status->ViewAttributes() ?>><?php echo $Page->package_status->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->payment_id->Visible) { ?>
		<td data-field="payment_id"<?php echo $Page->payment_id->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_package_subscribe_payment_id"<?php echo $Page->payment_id->ViewAttributes() ?>><?php echo $Page->payment_id->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "package_subscriberptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
</div>
