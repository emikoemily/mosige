...
$Chart->ID = "cv1_ByWeekday"; // Chart ID
...
<?php
	...
	ewr_SortChartData($Chart->Data, 1, "");
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_cv1_ByWeekday", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_cv1_ByWeekday_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
