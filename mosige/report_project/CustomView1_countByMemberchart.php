...
$Chart->ID = "CustomView1_countByMember"; // Chart ID
...
<?php
	...
	ewr_SortChartData($Chart->Data, 4, "");
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_CustomView1_countByMember", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_CustomView1_countByMember_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
