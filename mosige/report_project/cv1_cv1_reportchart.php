...
$Chart->ID = "cv1_cv1_report"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_cv1_cv1_report", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_cv1_cv1_report_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
