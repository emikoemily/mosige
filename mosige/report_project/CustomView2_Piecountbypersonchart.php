...
// Set up chart
//$Chart = &$Table->Piecountbyperson;
// Initialize chart data

$Chart->ID = "CustomView2_Piecountbyperson"; // Chart ID
$Chart->SetChartParms(array(array("type", "2", FALSE),
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_CustomView2_Piecountbyperson", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_CustomView2_Piecountbyperson_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
