...
$Chart->ID = "CustomView1_countByWeekday"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_CustomView1_countByWeekday", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_CustomView1_countByWeekday_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
