...
define("EWR_PROJECT_ID", "{55EDB588-8BCE-4361-B533-47C11315EBC4}", TRUE); // Project ID
...
if (!defined("EW_USE_mysqliI"))
	define('EW_USE_mysqliI', extension_loaded("mysqlii"), TRUE); // Use mysqlii
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "mysqli", "host" => "127.0.0.1", "port" => 3306, "user" => "yoga_lu", "pass" => "Yooq_yoga_lu", "db" => "yoga_lu", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'fk28gqDu3zqN0EOt', TRUE); // Random key for encryption
...
/**
 * mysqli charset (for SET NAMES statement, not used by default)
 * Note: Read http://dev.mysqli.com/doc/refman/5.0/en/charset-connection.html
 * before using this setting.
 */
define("EWR_mysqli_CHARSET", "", TRUE);
...
// Use collation for mysqli
define("EWR_LIKE_COLLATION_FOR_mysqli", "", TRUE);
