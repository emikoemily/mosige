...
$Chart->ID = "cv1_PersonTimeChart"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_cv1_PersonTimeChart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_cv1_PersonTimeChart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
