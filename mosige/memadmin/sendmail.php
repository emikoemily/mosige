...
$maildebug->Username = "mosige_life";     // SMTP username  注意：普通邮件认证不需要加 @域名    
$maildebug->Password = "cfoiuxtjehcpcttw"; // SMTP password    
$maildebug->From = "mosige_life@163.com";      // 发件人邮箱    
$maildebug->FromName =  "管理员";               // send via SMTP    
$maildebug->Host = "smtp.163.com"; 
//Set who the message is to be sent from
$maildebug->setFrom('mosige_life@163.com', 'Mosige Yoga');
//Set an alternative reply-to address
$maildebug->addReplyTo('mosige_life@163.com', 'Mosige Yoga');
//Set who the message is to be sent to
//$mail->addAddress('service_mosige@163.com', 'Mosige');
$maildebug->addAddress('mosige_life@163.com', 'zz');
//$mail->addAddress('30540281@qq.com','mosige');
//Set the subject line
$maildebug->Subject = 'mosige_debug';
$maildebug->Charset = 'utf8';