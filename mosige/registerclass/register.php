...
//if($_SESSION["usercell"]=='13810532905'){
	showclass("[假期提前预约]四月三十日","2016-04-30",$_SESSION['userlevel'],$_SESSION["hasextended"],$db,$disable,$sqlpackagebase,$sqlbase,$overcount,$arr_packageid);
	showclass("[假期提前预约]五月一日","2016-05-01",$_SESSION['userlevel'],$_SESSION["hasextended"],$db,$disable,$sqlpackagebase,$sqlbase,$overcount,$arr_packageid);
	showclass("[假期提前预约]五月二日","2016-05-02",$_SESSION['userlevel'],$_SESSION["hasextended"],$db,$disable,$sqlpackagebase,$sqlbase,$overcount,$arr_packageid);
